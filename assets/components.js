                      ...
                      this.fetchCart(),
                        ...
                        this.addToCart.forEach(function (e) {
                          e.addEventListener("click", function (a) {
                            a.preventDefault();
                            var r = e.parentNode.parentNode.getAttribute("id");
                            t.addItemToCart(r);
                          });
                        }),
                    ...
                    value: function (e) {
                      ...
                      this.clearCartDrawer(),
                        e.items.forEach(function (e, a) {
                          ...
                          r.cartDrawerContent.innerHTML += n;
                        }),
                      ...
                      this.clearMiniCart(),
                        e.items.forEach(function (e, a) {
                          ...
                          var n = '\n        <div class="go-cart-item__single" data-line="'
                            ...
                            .concat(r.removeFromCartNoDot, '">')
                            .concat(o.remove, "</a>\n        </div>\n      ");
                          r.cartMiniCartContent.innerHTML += n;
                        }),
